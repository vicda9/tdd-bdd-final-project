...
Scenario: Create a Product
    ...
    Then the "Description" field should be empty
...
Scenario: Update a Product
    ...
    And I set the "Description" to "A fancy black fedora"
    And I set the "Price" to "74.95"
    ...
    And I should see "A fancy black fedora" in the "Description" field
    And I should see "False" in the "Available" dropdown
    And I should see "Cloths" in the "Category" dropdown
    And I should see "74.95" in the "Price" field
